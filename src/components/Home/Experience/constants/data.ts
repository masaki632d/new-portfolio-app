...
export const data = [
  ...
  },
  {
    ...
    description: [
      ...
      '<b>デザインツール</b><br>Photoshop / Illustrator',
    ],
  ...
  },
  {
    ...
    endDate: '2017-01',
    description: [
      '<b>概要</b><br>複数の医療系求人サイトのWeb制作を担当（デザイン・コーディング・社内ディレクション・施策の企画）。<br>Webデザイナー / コーダー / ディレクターを兼務し、施策に基づく新規コンテンツ制作や、採用サイトの制作などを担当しました。',
      '<b>得た経験</b><br>仕事を通して、医療系サービス特有のドメイン知識の獲得や、Web制作の流れ（ディレクション/デザイン/コーディング）や、他職能との連携などを経験することができました。',
      '<b>技術スタック</b><br>HTML / CSS / Sass / JavaScript / jQuery / PHP',
      '<b>周辺ツール</b><br>Wordpress / Git / Subversion',
      '<b>デザインツール</b><br>Photoshop / Illustrator / Fireworks',
    ],
    url: '/',
    logo: logo_mediamade,
  },
