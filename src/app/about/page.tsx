    ...
    <main className="relative mx-auto max-w-3xl px-6 md:px-16 lg:max-w-7xl">
      <section className="relative mb-8 grid grid-cols-1 justify-items-center gap-x-6 lg:grid-cols-custom">
        <div className="order-2 lg:order-none">
          <Slide>
            <h1 className="mb-8 basis-1/2 font-incognito text-3xl font-bold tracking-tight sm:text-5xl lg:leading-tight">
              About
            </h1>
            <div className="space-y-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                現在は、<strong> 金融系の⾃社Webメディア運営会社 </strong>{' '}
                である エイチームライフザイン社 に、{' '}
                <strong> Webデザイナー </strong>
        ...
        <aside className="order-none mb-12 gap-y-8 lg:order-1">
          <Slide delay={0.1}>
